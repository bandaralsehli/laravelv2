...
@section('content')
 ...
 <p class="max-w-screen-2xl text-center text-4xl font-bold">الإعدادت العامة</p>

    <div class="relative md:ml-64 bg-blueGray-100 mb-12 " id="masherfen">

        <div class="relative bg-blueGray-800 md:pt-16 pb-32  ">
